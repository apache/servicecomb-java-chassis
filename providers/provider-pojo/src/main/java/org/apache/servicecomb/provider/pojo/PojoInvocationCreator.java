...
public class PojoInvocationCreator {
  public Invocation create(PojoConsumerOperationMeta consumerOperationMeta, Object[] args) {
  ...
  protected ReferenceConfig createReferenceConfig(PojoConsumerOperationMeta consumerOperationMeta) {
