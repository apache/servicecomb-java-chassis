...
public class MicroserviceVersionMetaFactory implements MicroserviceVersionFactory {
  ...
  public MicroserviceVersionMetaFactory() {
    classLoaderFactory = DefaultMicroserviceClassLoaderFactory.INSTANCE;
  }

  public MicroserviceVersionMetaFactory(MicroserviceClassLoaderFactory classLoaderFactory) {
    this.classLoaderFactory = classLoaderFactory;
  }

  @Override
  public MicroserviceVersion create(String microserviceName, String microserviceId) {
    return new MicroserviceVersionMeta(microserviceName, microserviceId, classLoaderFactory);
  }
}
