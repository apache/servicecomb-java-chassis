...
import io.servicecomb.serviceregistry.filter.AbstractTransportDiscoveryFilter;
import io.servicecomb.serviceregistry.filter.DiscoveryFilterContext;

public class TransportEndpointDiscoveryFilter extends AbstractTransportDiscoveryFilter {
  @Override
  public int getOrder() {
