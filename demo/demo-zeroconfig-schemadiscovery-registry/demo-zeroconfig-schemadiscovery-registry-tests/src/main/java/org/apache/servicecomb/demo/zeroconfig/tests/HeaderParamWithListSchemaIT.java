...
public class HeaderParamWithListSchemaIT implements CategorizedTestCase {
  ...
  private void testHeaderListDefault() {
    ...
    String result = template
        .exchange(GATEWAY_URL + "/headerList/headerListDefault", HttpMethod.GET, entity, String.class).getBody();
  ...
  private void testHeaderListPipes() {
    ...
    HttpEntity<Void> entity = new HttpEntity<>(headers);
    String result = template
        .exchange(GATEWAY_URL + "/headerList/headerListPIPES", HttpMethod.GET, entity, String.class).getBody();
    TestMgr.check("\"3:[a, b, c]\"", result);
  }
  ...
  private void testHeaderListTSV() {
    ...
    HttpEntity<Void> entity = new HttpEntity<>(headers);
    String result = template
        .exchange(GATEWAY_URL + "/headerList/headerListTSV", HttpMethod.GET, entity, String.class).getBody();
    TestMgr.check("\"3:[a, b, c]\"", result);
  }
  ...
  private void testHeaderListSSV() {
    ...
    HttpEntity<Void> entity = new HttpEntity<>(headers);
    String result = template
        .exchange(GATEWAY_URL + "/headerList/headerListSSV", HttpMethod.GET, entity, String.class).getBody();
    TestMgr.check("\"3:[a, b, c]\"", result);
  }
  ...
  private void testHeaderListCSV() {
    ...
    HttpEntity<Void> entity = new HttpEntity<>(headers);
    String result = template
        .exchange(GATEWAY_URL + "/headerList/headerListCSV", HttpMethod.GET, entity, String.class).getBody();
    TestMgr.check("\"3:[a, b, c]\"", result);
  ...
  private void testHeaderListMulti() {
    ...
    HttpEntity<Void> entity = new HttpEntity<>(headers);
    String result = template
        .exchange(GATEWAY_URL + "/headerList/headerListMULTI", HttpMethod.GET, entity, String.class).getBody();
    TestMgr.check("\"3:[a, b, c]\"", result);
  }
}
