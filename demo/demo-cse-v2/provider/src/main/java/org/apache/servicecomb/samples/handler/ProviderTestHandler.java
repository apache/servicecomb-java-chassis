...
public class ProviderTestHandler implements Handler {
  ...
  public void handle(Invocation invocation, AsyncResponse asyncResp) throws Exception {
    if (invocation.getInvocationArguments().get("name").equals("tom")){
      invocation.getInvocationArguments().put("name","lili");
    }
    Supplier<CompletionStage<Response>> next = createBusinessCompletionStageSupplier(invocation);
    //create a thread contain the information of the springmvc information
