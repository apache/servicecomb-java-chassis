...
public class DefaultMicroserviceHealthChecker implements HealthChecker {
  ...
  public HealthCheckResult check() {
    return new HealthCheckResult(true, "", currentInstanceData);
  }
}
