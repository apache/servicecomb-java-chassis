...
public class DefaultMetricsEventListenerManager implements MetricsEventListenerManager {

  public DefaultMetricsEventListenerManager(MetricsRegistry registry, MetricFactory factory) {
