...
public class TestZeroConfigRegistryClientImpl {
    ...
    public void test_getSchema_whenProviderEndpointIsNull_shouldThrowIllegalArgumentException(){
        ClientUtil.microserviceSelf = prepareService(selfServiceId, true);
        when(zeroConfigRegistryService.getMicroservice(otherServiceId)).thenReturn(prepareServerServiceInstance(false));
    ...
    @Test
    public void test_registerMicroserviceInstance_withNullInstanceId_shouldGenerateInstanceId_and_succeed() throws IOException {
        ClientUtil.microserviceSelf = prepareService(selfServiceId, true);
        ...
        Assert.assertNotNull(ClientUtil.serviceInstanceMapForHeartbeat);
        Assert.assertEquals(instanceId, ClientUtil.serviceInstanceMapForHeartbeat.get(INSTANCE_ID));
    }

    @Test
    public void test_unregisterMicroserviceInstance_whenInstanceNotExist_shoulReturnFalse() throws IOException {
        when(zeroConfigRegistryService.findServiceInstance(selfServiceId, selfInstanceId)).thenReturn(Optional.empty());
    ...
    @Test
    public void test_unregisterMicroserviceInstance_withNullInstanceId_shouldGenerateInstanceId_and_succeed() throws IOException {
        when(zeroConfigRegistryService.findServiceInstance(selfServiceId, selfInstanceId)).thenReturn(Optional.of(prepareServerServiceInstance(true)));
        doNothing().when(multicastSocket).send(anyObject());
    ...
    public void test_findServiceInstances_forNonExistInstance_shouldReturnEmptyResult() {
        ...
        when(zeroConfigRegistryService.findServiceInstances(selfServiceId, selfInstanceId)).thenReturn(serverMicroserviceInstancesList);

        MicroserviceInstances returnedResult = target.findServiceInstances("" , appId, serviceName, strVersionRule, "");
    ...
    public void test_findServiceInstances_forExistInstance_shouldReturnInstances() {
        ...
        when(zeroConfigRegistryService.findServiceInstances(appId, serviceName)).thenReturn(serverMicroserviceInstancesList);

        MicroserviceInstances returnedResult = target.findServiceInstances("" , appId, serviceName, strVersionRule, "");
        List<MicroserviceInstance> returnedInstanceList = returnedResult.getInstancesResponse().getInstances();
    ...
    public void test_findServiceInstance_forExistInstance_shouldReturnInstance() {
        when(zeroConfigRegistryService.findServiceInstance(otherServiceId, selfInstanceId)).thenReturn(Optional.of(prepareServerServiceInstance(true)));

        MicroserviceInstance returnedResult = target.findServiceInstance(otherServiceId, selfInstanceId);
