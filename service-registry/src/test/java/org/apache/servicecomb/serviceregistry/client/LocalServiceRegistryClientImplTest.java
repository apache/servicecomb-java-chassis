...
public class LocalServiceRegistryClientImplTest {
  ...
  public void getMicroserviceId_appNotMatch() {
    ...
    Assert.assertEquals(200, registryClient.getMicroserviceId(appId, microserviceName, "1.0.0", "").getStatusCode());
    Assert.assertNull(registryClient.getMicroserviceId(appId, microserviceName, "1.0.0", "").getValue());
  }
  ...
  public void getMicroserviceId_versionNotMatch() {
    ...
    Assert.assertEquals(200, registryClient.getMicroserviceId(appId, microserviceName, "2.0.0", "").getStatusCode());
    Assert.assertNull(registryClient.getMicroserviceId(appId, microserviceName, "2.0.0", "").getValue());
  }
  ...
  public void getMicroserviceId_latest() {
    ...
    Holder<String> serviceIdHolder = registryClient
        .getMicroserviceId(appId, microserviceName, DefinitionConst.VERSION_RULE_LATEST, "");
  ...
  public void getMicroserviceId_fixVersion() {
    ...
    String serviceId = registryClient.getMicroserviceId(appId, microserviceName, "1.0.0", "").getValue();
