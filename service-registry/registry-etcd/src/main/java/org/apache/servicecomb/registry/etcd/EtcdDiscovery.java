...
public class EtcdDiscovery implements Discovery<EtcdDiscoveryInstance> {
    ...
    private List<EtcdDiscoveryInstance> convertServiceInstanceList(List<KeyValue> keyValueList) {
        ...
        for (KeyValue keyValue : keyValueList) {
            ...
            EtcdInstance etcdInstance = MuteExceptionUtil.builder().withLog("convert json value to obj from etcd failure, {}", valueJson)
                    .executeFunctionWithDoubleParam(JsonUtils::readValue, valueJson.getBytes(StandardCharsets.UTF_8), EtcdInstance.class);
