...
public abstract class ConnectionBase {
  ...
  public VertxHandler<ConnectionBase> handler() {
    return (VertxHandler<ConnectionBase>) chctx.handler();
  }
  ...
  public abstract NetworkMetrics<ConnectionBase> metrics();

  protected synchronized void handleException(Throwable t) {
    NetworkMetrics<ConnectionBase> metrics = metrics();
    if (metrics != null) {
      metrics.exceptionOccurred((ConnectionBase)metric, remoteAddress(), t);
    }
  ...
  public void reportBytesRead(long numberOfBytes) {
    NetworkMetrics<ConnectionBase> metrics = metrics();
    if (metrics != null) {
      metrics.bytesRead((ConnectionBase)metric(), remoteAddress(), numberOfBytes);
    }
  }
  ...
  public void reportBytesWritten(long numberOfBytes) {
    NetworkMetrics<ConnectionBase> metrics = metrics();
    if (metrics != null) {
      metrics.bytesWritten((ConnectionBase)metric(), remoteAddress(), numberOfBytes);
    }
  }
