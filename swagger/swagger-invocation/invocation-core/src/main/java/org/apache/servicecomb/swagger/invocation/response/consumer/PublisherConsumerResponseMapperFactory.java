...
public class PublisherConsumerResponseMapperFactory implements ConsumerResponseMapperFactory {
  @Override
  public boolean isMatch(Type consumerType) {
    ...
    return ((ParameterizedType) consumerType).getRawType().equals(Publisher.class);
  }
