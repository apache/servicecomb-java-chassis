...
/**
 * Factory for {@link WebSocketClientWithContext}
 */
public class WebSocketClientPoolFactory implements ClientPoolFactory<WebSocketClientWithContext> {
  ...
  public WebSocketClientPoolFactory(WebSocketClientOptionsSPI option, WebSocketClientOptions webSocketClientOptions) {
    this.option = option;
  ...
  public WebSocketClientWithContext createClientPool(Context context) {
    final WebSocketClient webSocketClient = context.owner().createWebSocketClient(webSocketClientOptions);
    return new WebSocketClientWithContext(option, webSocketClient, context);
  }
}
