...
public class IntPriorityProperty extends PriorityProperty<Integer> {
  public IntPriorityProperty(Integer invalidValue, Integer defaultValue, String... priorityKeys) {
    super(invalidValue, defaultValue, PropertyGetter::getIntProperty, priorityKeys);
  }
}
