...
public class LongPriorityProperty extends PriorityProperty<Long> {
  public LongPriorityProperty(Long invalidValue, Long defaultValue, String... priorityKeys) {
    super(invalidValue, defaultValue, PropertyGetter::getLongProperty, priorityKeys);
  }
}
