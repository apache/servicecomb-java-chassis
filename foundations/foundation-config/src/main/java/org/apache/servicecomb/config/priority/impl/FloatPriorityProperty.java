...
public class FloatPriorityProperty extends PriorityProperty<Float> {
  public FloatPriorityProperty(Float invalidValue, Float defaultValue, String... priorityKeys) {
    super(invalidValue, defaultValue, PropertyGetter::getFloatProperty, priorityKeys);
  }
}
