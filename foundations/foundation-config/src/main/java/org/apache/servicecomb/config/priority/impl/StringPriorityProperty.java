...
public class StringPriorityProperty extends PriorityProperty<String> {
  public StringPriorityProperty(String invalidValue, String defaultValue, String... priorityKeys) {
    super(invalidValue, defaultValue, PropertyGetter::getStringProperty, priorityKeys);
  }
}
