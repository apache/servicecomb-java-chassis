...
public class DoublePriorityProperty extends PriorityProperty<Double> {
  public DoublePriorityProperty(Double invalidValue, Double defaultValue, String... priorityKeys) {
    super(invalidValue, defaultValue, PropertyGetter::getDoubleProperty, priorityKeys);
  }
}
