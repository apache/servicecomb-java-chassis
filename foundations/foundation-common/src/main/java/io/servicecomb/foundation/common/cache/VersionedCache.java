...
public class VersionedCache {
  ...
  public VersionedCache autoCacheVersion() {
    this.cacheVersion = VERSION.incrementAndGet();
    return this;
  }

  public VersionedCache cacheVersion(VersionedCache other) {
  ...
  public VersionedCache name(String name) {
    this.name = name;
    return this;
  }

  public VersionedCache subName(VersionedCache parent, String subName) {
  ...
  public VersionedCache data(Object data) {
    this.data = data;
